...
| **УЧАСНИКИ:**          | Користувач (гість), Система|
| **ПЕРЕДУМОВИ:**        | Користувач має зареєстрований обліковий запис|
| **РЕЗУЛЬТАТ:**         | Користувач успішно увійшов до системи|
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | Некоректна електронна пошта — IncorrectEmail <br/> Некоректний пароль — IncorrectPassword|
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Користувач натискає кнопку «Увійти» на головній сторінці. <br/> 2. Вводить електронну пошту та пароль у форму входу. <br/> 3. Натискає кнопку «Підтвердити вхід». <br/> 4. Система перевіряє облікові дані. <br/> 5. Система повідомляє про успішний вхід. |
...
| **УЧАСНИКИ:**          | Користувач (гість), Система|
| **ПЕРЕДУМОВИ:**        | Користувач не має зареєстрованого облікового запису|
| **РЕЗУЛЬТАТ:**         | Обліковий запис користувача створено|
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | Пароль не відповідає вимогам — InvalidPassword <br/> Вказана електронна пошта недійсна — InvalidEmail|
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Користувач натискає кнопку «Зареєструватися» на головній сторінці. <br/> 2. Вводить електронну пошту та пароль у форму реєстрації. <br/> 3. Натискає кнопку «Підтвердити реєстрацію». <br/> 4. Система перевіряє введені дані. <br/> 5. Система надсилає лист-підтвердження на вказану електронну пошту. <br/> 6. Користувач підтверджує реєстрацію за посиланням у листі. <br/> 7. Система створює обліковий запис. <br/> 8. Система повідомляє про успішну реєстрацію. |
...
![logoutDiagram](//www.plantuml.com/plantuml/png/SYWkIImgAStDuIhEpimhI2nAp5LmJ2x9BCiigNHAJCvEByelpKjnpi_9BrB8oKpFA4dAAKtbKe226a1XL9EJ8Gn4zpt5X6F8niFeLZq02w5HsPaOKXCJGxn1HOZyq7A5DpVoZIxDbsz1sfbvFsyetf3r7hFMsgZ7WAXFbVlLB9sxm3iRZOsnyjO9ZuIC0wjwAV226Oi12c4_2huutFWDI1gmYEcQ0ukaZnhAyveziIC10oOc6maqVQQfy64ibXDsn8fIhuX_E6tLQqSxpYAjQgh-tmpH_7lBPoOyTspwJ28EOhDGfEOrQ8jagmbvipuOMF0j97oI44oRasphia_70sRacVBaBxszAztbzSqLt-e7)

<hr />

| **ID:**                | <span id="Search"> Search </span>|
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| **НАЗВА:**             | Пошук даних за запитом |
| **УЧАСНИКИ:**          | Користувач, Система|
| **ПЕРЕДУМОВИ:**        | У системі наявна база даних для пошуку|
| **РЕЗУЛЬТАТ:**         | Відібрані за запитом дані відображено користувачу|
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | Дані не знайдено — DataNotFound|
| **ОСНОВНИЙ СЦЕНАРІЙ:** | 1. Користувач натискає кнопку «Пошук» на головній сторінці. <br/> 2. Вводить запит у пошуковий рядок. <br/> 3. Натискає кнопку «Знайти». <br/> 4. Система виконує пошук за введеним запитом. <br/> 5. Система виводить результати пошуку користувачу. |
